...
function getGeneration(cells, generations){
    ...
    var bottomRight = 0;
      ...
      if(newArr[h][i] > 0){
        if((topLeft+top+topRight+left+right+bottomLeft+bottom+bottomRight) > 3 || (topLeft+top+topRight+left+right+bottomLeft+bottom+bottomRight) < 2){
        ...
        if((topLeft+top+topRight+left+right+bottomLeft+bottom+bottomRight)===3){
  ...
  getGeneration([[1,0,0],[0,1,1],[1,1,0]], 2);